#!/usr/bin/env ruby
#
# Assignment block tidier
# Original version by Chris Poirier
# Copyright Chris Poirier 2006, Dr Nic Williams 2008
#
# This script can be used as a command for TextMate to align all 
# of the assignment equal signs (:=) within a block of text.  When using it with
