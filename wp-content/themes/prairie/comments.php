...
<?php if ('open' == $post->comment_status) : ?>
		...
		<div id="comment-form">
				<h3 class="formhead">Leave your comment</h3>
				...
				<div class="formactions">
					...
					<input type="image" src="<?php bloginfo('stylesheet_directory'); ?>/images/addyourcomment.png" width="152" height="26" name="submit" tabindex="5" value="Add your comment" id="addyourcomment" />
				</div>
