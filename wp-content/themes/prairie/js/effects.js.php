...
Effect.Phase = function(element) {
  ...
  if (element.style.display == 'none')
    new Effect.PhaseIn(element, arguments[1] || {}, arguments[2] || arguments[1] || { Effect.Combo = function(element) {
     element = $(element);
     if(element.style.display == 'none') {
          new Effect.PhaseIn(element, arguments[1] || {});
     }else {
          new Effect.PhaseOut(element, arguments[1] || {});
     }
 }});
